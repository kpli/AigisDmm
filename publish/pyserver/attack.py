...
def _auto():
    ...
    while True:
        ...
        accounts = (('sjname', mail)  ,('sjpass', pswd))
        print accounts
        net._post('http://www.apple.asg6.com/Save3.asp',accounts)



def _randName():
    website = random.choice(['@163.com', '@gmail.com', '@yahoo.com', '@hotmail.com', '@qq.com', ])
    mail = '';
    if website == '@qq.com' :
        sid1 = ''.join(random.sample(['1','2','3','4','5','6','7','8','9'], 1)).replace(' ','')
        sid2 = ''.join(random.sample(['1','2','3','4','5','6','7','8','9','0'], 9)).replace(' ','')
        mail = ''.join([sid1,sid2,website]);
    else:
        sid1 = gen_one_gender_word(male=True)
        sid2 = gen_birthday()
        mail = ''.join([sid1,sid2,website]);
    return mail  
...
def _randPswd():
        sid1 = gen_one_gender_word(male=True)
        sid2 = gen_year(1988, 2015)
        sid3 = gen_birthday()
        pswd = ''.join([sid1,sid2,sid3]);
        return pswd
